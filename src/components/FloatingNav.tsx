...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'http://github.com/DIVYKUMAR12345', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/divykumar-patel/', label: 'LinkedIn' },
    // { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/pateldivy_12345?igsh=cHhycnl5OG1lNHZh', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/DIVYKUMAR_PATEL/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:pateldivy548@gmail.com', label: 'Email' },
  ];
