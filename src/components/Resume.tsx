  ...
  return (
    <section id="resume" className="resume-section">
      <div className="resume-container">
        ...
        >
          <a href="/resume-fina.pdf" download className="download-btn">
            <Download size={20} />
            Download Resume
          </a>
        </motion.div>
        ...
        >
          ...
          >
            ...
            📩 pateldivy548@gmail.com | 📱 +91 7984945934
          </motion.p>
          ...
          >
            Passionate Computer Science & Engineering student with strong skills in frontend and 
            full-stack web development, focused on building responsive and user-centric websites.
            Experienced in modern web technologies, SEO, and continuous learning, driven to create 
            practical and impactful digital solutions.
          </motion.p>
        </motion.div>
            ...
            {[
              {
                ...
                school: "SOCET — Silver Oak College of Engineering and Technology, Ahmedabad",
                period: "2024 – 2027",
                detail: "Current CGPA: 9.67",
              },
              {
              ...
              },
              {
                ...
                school: "Mahesana Urban Vidyalaya",
                period: "2020 – 2021",
                detail: "85%",
              },
            ].map((edu, i) => (
        ...
        >
          ...
          <div className="skill-tags">
            {[
              "Python","Java","HTML5","CSS3","JavaScript","ReactJS","Bootstrap","Git","SQL", "MySQL","PHP/WordPress","SEO","Data Science","Data Analytics","Cloud Computing","AI/ML",
              "MongoDB","NLP","DL","Creativity","Teamwork"
            ].map((skill, i) => (
              <motion.span
                key={skill}
